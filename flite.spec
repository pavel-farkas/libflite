...
Patch0:         flite.texi.patch
Patch1:         no_rpath.patch
Patch2:         shlib_deps.patch
Patch3:         CVE-2014-0027_unsafe_temporary_file.patch
Patch4:         link_deps.patch
Patch5:         texi2html_to_texi2any_migration.patch
Patch6:         verbose
Patch7:         typos-found-by-lintian.patch
Patch8:         example_fix
Patch9:         64bit
...
%endif
BuildRequires:  ed alsa-lib-devel autoconf texinfo
...
%if 0%{?el4}
# there is no texi2html for RHEL 4
%doc ACKNOWLEDGEMENTS COPYING
%else
%doc ACKNOWLEDGEMENTS COPYING doc/html
%endif
%{_libdir}/*.so.*
%{_bindir}/*
